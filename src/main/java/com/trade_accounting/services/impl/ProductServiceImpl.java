...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductServiceImpl(ProductRepository productRepository,
                              ...
                              AttributeOfCalculationObjectRepository attributeOfCalculationObjectRepository, ImageRepository imageRepository, TypeOfPriceRepository typeOfPriceRepository, ProductPriceRepository productPriceRepository, DtoMapper dtoMapper) {
...
//        }
        return productRepository.findAll().stream()
                .map(dtoMapper::productToProductDto).collect(Collectors.toList());
    }
...
//        productDto.setProductPriceDtos(list);
        return dtoMapper.productToProductDto(
...
//                productPrices
//        ));
        Product product = productRepository.save(dtoMapper.productDtoToProduct(productDto));
...
////        }
//        return productDtos;
        List<Product> productList = productRepository.getAllByProductGroupId(id);
        return productList.stream().map(dtoMapper::productToProductDto).collect(Collectors.toList());

    }

    @Override
    public List<ProductDto> getAllLiteByProductGroupId(Long id) {
        return productRepository.getAllByProductGroupId(id).stream()
                .map(dtoMapper::productToProductDto).collect(Collectors.toList());
    }
...
//        }
//        return productDtos;
        List<Product> productList = productRepository.getAllByContractorId(id);
        return  productList.stream().map(dtoMapper::productToProductDto).collect(Collectors.toList());
    }
}
