...
public class DataInitializer {
    ...
    private void initProductGroups(){
        ...
        productGroupService.create(new ProductGroupDto("Товарная группа №6", "6", 1L));
        productGroupService.create(new ProductGroupDto("Товарная группа №7", "7", 6L));

        productGroupService.create(new ProductGroupDto("Товарная группа №8", "8", 2L));
        productGroupService.create(new ProductGroupDto("Товарная группа №9", "9", 7L));

        productGroupService.create(new ProductGroupDto("Товарная группа №10", "10", 3L));
        productGroupService.create(new ProductGroupDto("Товарная группа №11", "11", 8L));

        productGroupService.create(new ProductGroupDto("Товарная группа №12", "12", 4L));
        productGroupService.create(new ProductGroupDto("Товарная группа №13", "13", 9L));

        productGroupService.create(new ProductGroupDto("Товарная группа №14", "14", 5L));
        productGroupService.create(new ProductGroupDto("Товарная группа №15", "15", 10L));
    }
