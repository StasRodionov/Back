...
public interface ImageRepository extends JpaRepository<Image, Long> {
    ...
    @Query("select new com.trade_accounting.models.dto.ImageDto(i.id, i.imageUrl, i.sortNumber) from Image i inner join Product p where p.id = :id")
    List<ImageDto> getAllDtoById(@Param("id") Long id);
