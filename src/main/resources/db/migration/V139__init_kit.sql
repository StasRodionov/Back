...
INSERT INTO kits (
    ...
    department_id,
    access_all)
VALUES (1, 'Джентельменский набор №1', 'Костюм тройка, туфли, галстук', false, 0, 0, 33.33, 1, 1, 1, '20', 1, 1, false ),
       (2, 'Джентельменский набор №2', 'Костюм двойка, ,туфли, бабочка', false, 0, 0, 44.44, 1, 1, 1, '20', 1, 1, false ),
       (3, 'Джентельменский набор №3', 'Пиджак, джинсы, ботинки', false, 0, 0, 55.55, 1, 1, 1, '20', 1, 1, false );
