INSERT INTO movement (id, comment, date, when_changed_date, is_print, is_sent, is_spend, company_id, project_id, employee_changed_id, warehouse_from_id, warehouse_to_id)
