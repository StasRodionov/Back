...
(
    ...
    company_id              BIGINT,
    delivery_planned_moment TIMESTAMP WITHOUT TIME ZONE,
    material_warehouse      VARCHAR(255),
    production_warehouse    VARCHAR(255),
...
ALTER TABLE technical_processes
    ADD CONSTRAINT FK_TECHNICAL_PROCESSES_ON_DEPARTMENTOWNER FOREIGN KEY (department_owner_id) REFERENCES departments (id);

ALTER TABLE technical_processes
    ADD CONSTRAINT FK_TECHNICAL_PROCESSES_ON_EMPLOYEEOWNER FOREIGN KEY (employee_owner_id) REFERENCES employees (id);

ALTER TABLE technical_processes
    ADD CONSTRAINT FK_TECHNICAL_PROCESSES_ON_EMPLOYEEWHOLASTCHANGED FOREIGN KEY (employee_who_last_changed_id) REFERENCES employees (id);
