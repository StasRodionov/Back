insert into public.remains (id, available, balance, cost_price, days_on_warehouse, expectation, irreducible_balance, name, reserve, sales_cost, sales_sum, sum_of_cost_price, vendor_code, unit_id)
