...
//        List<Long> bankAccountId = new ArrayList<>();
//
//        if (company == null) {
//            return  null;
//        } else {
...
//            companyDto.setSortNumber(company.getSortNumber());
//            companyDto.setPhone(company.getPhone());
//            companyDto.setFax(company.getFax());
//            companyDto.setEmail(company.getEmail());
//            companyDto.setPayerVat(company.getPayerVat());
//            companyDto.setCommentToAddress(company.getCommentToAddress());
//            companyDto.setLeader(company.getLeader());
//            companyDto.setLeaderManagerPosition(company.getLeaderManagerPosition());
//            companyDto.setLeaderSignature(company.getLeaderSignature());
//            companyDto.setChiefAccountant(company.getChiefAccountant());
//            companyDto.setChiefAccountantSignature(company.getChiefAccountantSignature());
//            companyDto.setStamp(company.getStamp());
//
//            Address address = company.getAddress();
//            if (address == null) {
//                companyDto.setAddressId(null);
//            } else {
//                companyDto.setAddressId(address.getId());
//            }
//
//            LegalDetail legalDetail = company.getLegalDetail();
//            if (legalDetail == null) {
//                companyDto.setBankAccountDtoIds(null);
//            } else {
//                companyDto.setLegalDetailDtoId(legalDetail.getId());
//            }
//
//            List<BankAccount> bankAccount = company.getBankAccounts();
//            if (bankAccount == null) {
//                companyDto.setBankAccountDtoIds(null);
//            } else {
//                bankAccountId = bankAccount.stream()
//                        .map(BankAccount::getId)
//                        .collect(Collectors.toList());
//            }
//
//            companyDto.setBankAccountDtoIds(bankAccountId);
//
//            return companyDto;
//        }
//    }
