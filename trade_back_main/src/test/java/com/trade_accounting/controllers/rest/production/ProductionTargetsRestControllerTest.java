...
@Sql(value = "/src/test/resources/prepayout-before.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
...
public class ProductionTargetsRestControllerTest {
    ...
    void testGetById () throws Exception {
        String modelJson = new Gson().toJson(ProductionTargetsDto.builder()
                ...
                .materialWarehouseId(Long.valueOf(1))
                .productionWarehouseId(Long.valueOf(1))
