package com.trade_accounting.controllers.rest.purchases;
...
@Sql(value = "/src/test/resources/PurchaseControl-before.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
