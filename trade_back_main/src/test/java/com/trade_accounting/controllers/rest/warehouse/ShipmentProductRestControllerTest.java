...
@Sql(value = "/src/test/resources/shipmentProduct-before.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@WithUserDetails(value = "vasyaogon@mail.ru")
@AutoConfigureRestDocs(outputDir = "target/snippets", uriScheme = "http", uriPort = 4444)
public class ShipmentProductRestControllerTest {
    ...
    void testGetAll() throws Exception {
        mockMvc.perform(get("/api/shipmentproduct"))
                .andDo(print())
    ...
    void testGetById () throws Exception {
        String modelJson = new Gson().toJson(ShipmentProductDto.builder()
                .id(1L)
                .productId(1L)
        ...
        mockMvc.perform(get("/api/shipmentproduct/1"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(authenticated())
    ...
    void testCreate () throws Exception {
        ...
        mockMvc.perform(post("/api/shipmentproduct")
    ...
    void testUpdate() throws Exception {
        ...
        mockMvc.perform(put("/api/shipmentproduct")
                        .contentType(MediaType.APPLICATION_JSON).content(modelJson))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(authenticated())
    ...
    void testDeleteById() throws Exception {
        mockMvc.perform(delete("/api/shipmentproduct/1"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(authenticated())
                .andDo(MockMvcRestDocumentation.document("{class-name}/{method-name}"));
